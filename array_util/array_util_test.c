...
void test_create_array_util_for_int(){
...
void test_create_array_util_for_float(){
...
void test_create_array_util_for_char(){
...
void test_are_equal_for_int_type_array_util(){
...
void test_are_equal_for_char_type_array_util(){
...
void test_resize_array_util_for_int_type(){
   ArrayUtil scores = create(4,5);
...
void test_resize_array_util_for_char_type(){
   ArrayUtil name = create(1,5);
...
void test_find_index_for_int_type(){
   ArrayUtil scores = create(4,5);
   int *s  = (int *)scores.base;
   s[0] = 92; s[1] = 90; s[2] = 45; s[3] = 76; s[4] = 54;
...
void test_find_index_for_char_type(){
...
void test_find_first_for_int_type(){
...
void test_find_first_for_char_type(){
...
void test_find_last_for_int_type(){
   ArrayUtil integers = create(sizeof(int),5);
   int *s  = (int *)integers.base;
   s[0] = 15, s[1] = 2, s[2] = 3, s[3] = 4, s[4] = 5;
   int divider1 =2;
...
void test_find_last_for_char_type(){
   ArrayUtil name = create(sizeof(char),5);
...
void test_filter_array_util_for_int_type(){
...
void test_map_should_copy_converted_element_in_destination(){
...
void test_map_should_cpy_converted_element_in_destination_for_char(){
   ArrayUtil name = create(sizeof(char) ,5);
   char *n = (char *)name.base;
   n[0] = 'h',n[1] = 'e',n[2] = 'l',n[3] = 'l',n[4] = 'o';
...
void test_forEach_executes_operation_for_each_int_element(){
...
void test_forEach_executes_operation_for_each_char_element(){
...
void test_reduce_reduces_the_list_and_gives_a_value(){
